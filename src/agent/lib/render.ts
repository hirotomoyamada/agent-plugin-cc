...
function formatAgentResumeCommand(
...
function appendActiveJobsTable(
  ...
  lines.push(
    "| Job | Kind | Status | Phase | Elapsed | Agent Session ID | Summary | Actions |",
  )
  lines.push("| --- | --- | --- | --- | --- | --- | --- | --- |")
...
export function renderStatusReport(report: Record<string, any>): string {
  ...
  if (report.needsReview) {
    ...
    lines.push(
      "Ending the session will trigger a fresh Agent adversarial review and block if it finds issues.",
    )
  }
