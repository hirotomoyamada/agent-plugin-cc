...
export const BROKER_ENDPOINT_ENV = CODEX_PROVIDER.envVars.brokerEndpoint
export const BROKER_BUSY_RPC_CODE = core.BROKER_BUSY_RPC_CODE

const DEFAULT_CLIENT_INFO: core.ClientInfo = {
  name: "Claude Code",
  title: CODEX_PROVIDER.appServer.clientTitle,
...
interface CodexClientOptions extends core.AppServerClientOptions {
...
export class CodexAppServerClient {
  static async connect(
    ...
    const client = await core.connectAppServer(CODEX_PROVIDER, cwd, {
      ...options,
