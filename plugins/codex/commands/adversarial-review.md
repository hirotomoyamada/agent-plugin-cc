...
```bash
node "${CLAUDE_PLUGIN_ROOT}/scripts/codex-companion.js" adversarial-review "$ARGUMENTS"
```
...
```typescript
Bash({
  command: `node "${CLAUDE_PLUGIN_ROOT}/scripts/codex-companion.js" adversarial-review "$ARGUMENTS"`,
