...
- `node "${CLAUDE_PLUGIN_ROOT}/scripts/kimi-companion.js" task "<raw arguments>"`
...
- You may use the `kimi-prompting` skill to rewrite the user's request into a tighter Kimi prompt before the single `task` call.
